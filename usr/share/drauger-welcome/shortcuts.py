...
try:
	...
	system("/usr/share/drauger-welcome/log-out 2 /usr/share/drauger-welcome/shortcuts.py 'Unknown error. Function show_shortcuts failed.' 'drauger-welcome' 'UNKNOWN' 'UNKNOWN'")
	exit(2)
