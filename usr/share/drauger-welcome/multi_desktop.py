...
try:
	...
	from os import system
	system("/usr/share/drauger-welcome/log-out 2 /usr/share/drauger-welcome/multi_desktop.py 'Unknown error. Function notify_show failed. 'drauger-welcome' 'UNKNOWN' 'UNKNOWN'")
